      ...
      <div class="row g-3 g-md-4 align-items-stretch">
        ...
        <div class="col-12 col-lg-6">
          <div class="left h-100">
            ...
            <p class="mb-4 text-center" style="opacity:.95">
        ...
        <div class="col-12 col-lg-6">
          <div class="p-3 p-md-4">
            ...
            <p class="muted mb-3 text-center">
            ...
            <form id="leadForm" novalidate>
              ...
              <div class="mb-3">
                ...
                <input name="cidade" type="text" class="form-control" placeholder="Ex: Belo Horizonte - MG" required>
              ...
              <div class="text-center mt-3">
                <a id="whatsTextLink" target="_blank" class="text-decoration-none fw-semibold" href="#">
